import pandas as pd
from config.base_config import column_config_path
from sklearn.pipeline import Pipeline
from sklearn.compose import ColumnTransformer
from preprocess.Preprocess import PreprocessMissvalue, PreprocessOutlier
from feature.FeatureProcess import FeaturesStandard, FeaturesEncoder
...
column_config.loc[(column_config.types == 'category') & (
    column_config.missvalue.isna()), 'missvalue'] = "SimpleImputer(strategy='most_frequent')"
column_config.loc[(column_config.types == 'numeric') & (
    column_config.missvalue.isna()), 'missvalue'] = "SimpleImputer(strategy='median')"
# default for encoder
